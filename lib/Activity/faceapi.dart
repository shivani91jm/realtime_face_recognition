...
class MyAppssss extends StatefulWidget {
  @override
  _MyAppssssState createState() => _MyAppssssState();
}

class _MyAppssssState extends State<MyAppssss> {
  var image1 = new MatchFacesImage();
  var image2 = new MatchFacesImage();
  var img1 = Image.network('https://websitedemoonline.com/facerecognition/uploads/65faba0cd6e46.png');
  var img2 = Image.network('https://websitedemoonline.com/facerecognition/uploads/65faba0cd6e46.png');
